...
execute at @e[type=marker, tag=sc_bw_lobby_blue_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_BLUE_TEAM sc_bw 1
execute at @e[type=marker, tag=sc_bw_lobby_red_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_RED_TEAM sc_bw 1
execute at @e[type=marker, tag=sc_bw_lobby_green_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_GREEN_TEAM sc_bw 1
execute at @e[type=marker, tag=sc_bw_lobby_yellow_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_YELLOW_TEAM sc_bw 1
execute at @e[type=marker, tag=sc_bw_lobby_pink_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_PINK_TEAM sc_bw 1
execute at @e[type=marker, tag=sc_bw_lobby_purple_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_PURPLE_TEAM sc_bw 1
execute at @e[type=marker, tag=sc_bw_lobby_black_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_BLACK_TEAM sc_bw 1
execute at @e[type=marker, tag=sc_bw_lobby_white_team] as @a[distance=..2.5, gamemode=!spectator] run scoreboard players add #START_WHITE_TEAM sc_bw 1
