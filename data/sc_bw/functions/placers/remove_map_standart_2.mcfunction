...
#kill items
execute as @e[type=marker, tag=sc_bw_map_center, tag=sc_bw_map_center_standart_2] run kill @e[type=minecraft:item,nbt={Item:{tag:{Tags:["sc_bw_item"]}}},distance=..100]
